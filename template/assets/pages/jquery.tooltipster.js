...
(function ($) {
    ...
    $('#tooltip-html').tooltipster({
        content: $('<img src="assets/images/users/avatar-2.jpg" width="50" height="50" /><p style="text-align:left;"><strong>Soufflรยฉ chocolate cake powder.</strong> Applicake lollipop oat cake gingerbread.</p>'),
