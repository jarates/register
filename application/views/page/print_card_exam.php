                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title m-0">พิมพ์บัตรผู้เข้าสอบ</h4>
                        </div>
                        ...
                        if(data.data.length > 0){
                            ...
                            $.each(data.data, function(key,val) {
                                ...
                                tr += '<tr>';
                                    ...
                                    tr += '<td>'+val.status+'</td>';
                                    tr += '<td><a href="'+val.url_print+'/print_card_exam/'+val.id+'" target="_blank" class="btn btn-info"><i class="fi-printer"></i> พิมพ์บัตรผู้เข้าสอบ</a></td>';
                                tr += '</tr>';
