    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <h4 class="page-title m-0">ยืนยันสิทธิ์ในการเข้าศึกษา</h4>
                        </div>
                                                    ...
                                                    <tbody id="tr-data">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($v->reg_status == 1 || $v->reg_status == 2){ ?>

                                                                <select data-id="<?=$v->reg_id?>" id="reg_status" name="reg_status" class="form-control reg_status" style="width: 140px;">
                                                                    <option value="">---โปรดเลือก---</option>
                                                                    <option value="2" <?php if($v->reg_status == 2){echo 'selected';} ?>>ยืนยันสิทธิ์</option>
                                                                </select>
        ...
        <script>
            ...
            $('.reg_status').on('change', function(){
                ...
                if(confirm('ยืนยันสิทธ์ไปยังผู้สมัคร ID = '+reg_id+' ใช่หรือไม่?')){
