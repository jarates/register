...
--
-- Host: localhost
-- Generation Time: Jan 13, 2019 at 08:28 PM
...
CREATE TABLE IF NOT EXISTS `account_login` (
  ...
  `login_level` int(1) NOT NULL COMMENT '0=admin,1=personal'
...
INSERT INTO `account_login` (`login_id`, `login_name`, `username`, `password`, `login_level`) VALUES
(1, 'ศักดิภูมิ โสยานาม', 'admin1', '$2y$10$/ysFkH/Z6hTIWYz1gehghOIl5z963hYoZ4TqlQZNqgxqrOh852szm', 0),
(2, 'ศักดิภูมิ โสยานาม', 'admin2', '$2y$10$b8UJWO9aFSi9eUbERJAduOLGfFr2ZU1UqyeAIQP319qQSXSIR9TtC', 0);
...
INSERT INTO `info_school` (`id`, `logo_pdf`, `school_name`, `website_name`, `website_title`, `website_footer`) VALUES
(1, 'info-school-2019-01-12-1547231189.png', 'มหาวิทยาลัยจ๋องแจ๊ง', 'มหาวิทยาลัยจ๋องแจ๊ง', 'มหาวิทยาลัยจ๋องแจ๊ง', '2016 - 2017 © ระบบสมัครเรียน มหาวิทยาลัยจ๋องแจ๊ง');
...
CREATE TABLE IF NOT EXISTS `info_website` (
  `website_name` varchar(255) DEFAULT NULL,
  `website_title` varchar(255) DEFAULT NULL,
  `website_footer` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `master_education` (
  ...
  `education_status` int(1) DEFAULT NULL,
  `education_date_create` datetime DEFAULT NULL,
  `education_date_update` datetime DEFAULT NULL,
  `education_date_delete` datetime DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `master_faculty` (
  ...
  `faculty_status` int(1) DEFAULT NULL,
  `faculty_date_create` datetime DEFAULT NULL,
  `faculty_date_update` datetime DEFAULT NULL,
  `faculty_date_delete` datetime DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `master_learning`
--

CREATE TABLE IF NOT EXISTS `master_learning` (
  `learning_id` int(11) NOT NULL,
  `period_id` int(11) NOT NULL,
  `learning_name` varchar(100) NOT NULL,
  `learning_fee` decimal(10,2) DEFAULT NULL,
  `learning_status` int(1) DEFAULT NULL,
  `learning_date_create` datetime DEFAULT NULL,
  `learning_date_update` datetime DEFAULT NULL,
  `learning_date_delete` datetime DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `master_learning`
--

INSERT INTO `master_learning` (`learning_id`, `period_id`, `learning_name`, `learning_fee`, `learning_status`, `learning_date_create`, `learning_date_update`, `learning_date_delete`) VALUES
(5, 1, 'ภาคปกติ (จ-ศ)', '400.00', NULL, NULL, NULL, NULL),
(6, 1, 'ภาคพิเศษ (ส-อา)', '500.00', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `master_majoring`
--

CREATE TABLE IF NOT EXISTS `master_majoring` (
  `majoring_id` int(11) NOT NULL,
  `faculty_id` int(11) NOT NULL,
  `majoring_code` varchar(20) NOT NULL,
  `majoring_name` varchar(150) NOT NULL,
  `majoring_status` int(1) DEFAULT NULL,
  `majoring_date_create` datetime DEFAULT NULL,
  `majoring_date_update` datetime DEFAULT NULL,
  `majoring_date_delete` datetime DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `master_period`
--

CREATE TABLE IF NOT EXISTS `master_period` (
  `period_id` int(11) NOT NULL,
  `period_year` int(4) NOT NULL,
  `period_date_begin` datetime NOT NULL,
  `period_date_end` datetime NOT NULL,
  `period_date_payment_end` date DEFAULT NULL,
  `what_has_been` varchar(255) DEFAULT NULL,
  `opening_date` varchar(100) DEFAULT NULL,
  `report_date` varchar(100) DEFAULT NULL,
  `period_status` int(1) NOT NULL COMMENT '0=disabled,1=enabled'
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `master_period`
--

INSERT INTO `master_period` (`period_id`, `period_year`, `period_date_begin`, `period_date_end`, `period_date_payment_end`, `what_has_been`, `opening_date`, `report_date`, `period_status`) VALUES
(1, 2019, '2018-12-25 00:00:00', '2018-12-27 17:00:00', '2018-12-30', 'เอกสารประกอบการลงทะเบียนเรียน', '21 กรกฏาคม 2562', '15 กรกฏาคม 2562', 1);
...
INSERT INTO `pages` (`page_id`, `about`, `contact`, `help`) VALUES
(1, '<p>ยังไม่มีข้อมูล</p>', '<p>ยังไม่มีข้อมูล</p>', '<p>ยังไม่มีข้อมูล</p>');
...
CREATE TABLE IF NOT EXISTS `programe` (
  ...
  `programe_date_create` datetime DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
INSERT INTO `programe` (`programe_id`, `programe_name`, `programe_date_create`) VALUES
(1, 'วิทย์-คณิต', NULL),
(2, 'คณิต-อังกฤษ (ศิลป์-คำนวณ)', NULL),
(3, 'อังกฤษ-ไทย-สังคม (ศิลป์-ภาษา)', NULL),
(4, 'ศิลป์ทั่วไป (ศิลปะ-กีฬา-อาชีพ)', NULL);
...
CREATE TABLE IF NOT EXISTS `register` (
  `reg_id` int(8) unsigned zerofill NOT NULL,
  `period_id` int(11) NOT NULL,
  `reg_level` int(1) DEFAULT NULL,
  `reg_date_create` date NOT NULL,
  `reg_picture` varchar(150) NOT NULL,
  `reg_code` varchar(13) NOT NULL,
  `reg_name_prefix` varchar(30) NOT NULL,
  `reg_fname` varchar(100) NOT NULL,
  `reg_lname` varchar(100) NOT NULL,
  `reg_gender` varchar(10) NOT NULL,
  `reg_race` varchar(80) NOT NULL,
  `reg_nationality` varchar(80) NOT NULL,
  `reg_religion` varchar(80) NOT NULL,
  `reg_birthday` date NOT NULL,
  `reg_addr_number` varchar(20) NOT NULL,
  `reg_addr_village` varchar(100) NOT NULL,
  `reg_addr_moo` varchar(20) NOT NULL,
  `reg_addr_tumbon` int(11) NOT NULL,
  `reg_addr_district` int(11) NOT NULL,
  `reg_addr_province` int(11) NOT NULL,
  `reg_addr_zipcode` varchar(10) NOT NULL,
  `reg_tel` varchar(15) NOT NULL,
  `reg_name_father` varchar(150) NOT NULL,
  `reg_age_father` int(3) NOT NULL,
  `reg_career_father` varchar(100) NOT NULL,
  `reg_office_father` varchar(150) NOT NULL,
  `reg_tel_father` varchar(15) NOT NULL,
  `reg_name_mother` varchar(150) NOT NULL,
  `reg_age_mother` int(3) NOT NULL,
  `reg_career_mother` varchar(100) NOT NULL,
  `reg_office_mother` varchar(150) NOT NULL,
  `reg_tel_mother` varchar(15) NOT NULL,
  `reg_from_school` varchar(255) NOT NULL,
  `reg_from_school_district` int(11) NOT NULL,
  `reg_from_school_province` int(11) NOT NULL,
  `reg_from_grade` decimal(10,2) NOT NULL,
  `reg_programe` int(2) NOT NULL,
  `reg_certificate1` enum('false','true') NOT NULL,
  `reg_certificate2` enum('false','true') NOT NULL,
  `reg_certificate3_picture` enum('false','true') NOT NULL,
  `reg_certificate4_home_student` enum('false','true') NOT NULL,
  `reg_certificate5_home_father` enum('false','true') NOT NULL,
  `reg_certificate6_home_mother` enum('false','true') NOT NULL,
  `learning_id` int(11) DEFAULT NULL,
  `education_id` int(11) DEFAULT NULL,
  `faculty_id` int(11) DEFAULT NULL,
  `majoring_id` int(11) DEFAULT NULL,
  `recruitment` varchar(255) DEFAULT NULL,
  `reg_status` int(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `register_period` (
  `period_id` int(11) NOT NULL,
  `period_name1` varchar(255) NOT NULL,
  `period_name4` varchar(255) NOT NULL,
  `period_fee1` decimal(10,2) NOT NULL,
  `period_fee4` decimal(10,2) NOT NULL,
  `period_quota1` int(11) NOT NULL,
  `period_quota4` int(11) NOT NULL,
  `period_reg_date_start` date NOT NULL,
  `period_reg_date_end` date NOT NULL,
  `period_due_date_paymeny` date NOT NULL,
  `period_year` int(4) NOT NULL,
  `period_active` enum('false','true') NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
INSERT INTO `register_period` (`period_id`, `period_name1`, `period_name4`, `period_fee1`, `period_fee4`, `period_quota1`, `period_quota4`, `period_reg_date_start`, `period_reg_date_end`, `period_due_date_paymeny`, `period_year`, `period_active`) VALUES
(1, 'เปิดรับสมัครเข้าเรียน ม.1 2560', 'เปิดรับสมัครเข้าเรียน ม.4 2560', '0.00', '0.00', 0, 0, '0000-00-00', '0000-00-00', '0000-00-00', 2017, 'false'),
(2, 'เปิดรับสมัครเข้าเรียน ม.1 2561', 'เปิดรับสมัครเข้าเรียน ม.4 2560', '0.00', '0.00', 0, 0, '2018-12-01', '2018-12-25', '2018-12-28', 2018, 'true');

-- --------------------------------------------------------

--
-- Table structure for table `_terminal_injection`
--

CREATE TABLE IF NOT EXISTS `_terminal_injection` (
  `id` int(11) NOT NULL,
  `ccsd` int(4) DEFAULT NULL,
  `iddso` int(3) DEFAULT NULL,
...
--
-- Indexes for table `info_school`
--
ALTER TABLE `info_school`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `master_faculty`
--
ALTER TABLE `master_faculty`
  ADD PRIMARY KEY (`faculty_id`);

--
-- Indexes for table `master_learning`
--
ALTER TABLE `master_learning`
  ADD PRIMARY KEY (`learning_id`);

--
-- Indexes for table `master_majoring`
--
ALTER TABLE `master_majoring`
  ADD PRIMARY KEY (`majoring_id`);

--
-- Indexes for table `master_period`
--
ALTER TABLE `master_period`
  ADD PRIMARY KEY (`period_id`),
  ADD UNIQUE KEY `period_year` (`period_year`);
...
--
-- Indexes for table `_terminal_injection`
--
ALTER TABLE `_terminal_injection`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `master_faculty`
--
ALTER TABLE `master_faculty`
  MODIFY `faculty_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=151;
--
-- AUTO_INCREMENT for table `master_learning`
--
ALTER TABLE `master_learning`
  MODIFY `learning_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `master_majoring`
--
ALTER TABLE `master_majoring`
  MODIFY `majoring_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=161;
--
-- AUTO_INCREMENT for table `master_period`
--
ALTER TABLE `master_period`
...
--
ALTER TABLE `pages`
  MODIFY `page_id` int(1) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `programe`
--
ALTER TABLE `programe`
  MODIFY `programe_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `register`
  MODIFY `reg_id` int(8) unsigned zerofill NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `_terminal_injection`
--
ALTER TABLE `_terminal_injection`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
